    ...
    describe("w/ no dupe spreads", () => {
      ...
      it("sorts 6 teams correctly, first team = locked & listed highest rank", () => {
        teamData = [
          ...
          { team: "ravens", spread: "1.5", locked: false, rank: null },
          { team: "pack", spread: "10", locked: false, rank: null },
          { team: "pats", spread: "4", locked: false, rank: null },
          { team: "titans", spread: "5", locked: false, rank: null },
        ];
      ...
      it("sorts 6 teams correctly, last team = locked & listed highest rank", () => {
        teamData = [
          { team: "chiefs", spread: "6", locked: false, rank: null },
          { team: "titans", spread: "5", locked: false, rank: null },
          { team: "bucs", spread: "1", locked: false, rank: null },
          { team: "ravens", spread: "1.5", locked: false, rank: null },
          { team: "pack", spread: "10", locked: false, rank: null },
      ...
      it("sorts 16 teams correctly", () => {
        teams = teams.map((team) => {
          if (team.team === "bills") team.spread = "1";
          if (team.team === "colts") team.spread = "9";
          if (team.team === "titans") team.spread = "4";
          if (team.team === "wash") team.spread = "5.5";
          if (team.team === "eagles") {
            team.spread = "10";
            team.locked = true;
            team.rank = 14;
          }
          if (team.team === "browns") team.spread = "1.5";
          if (team.team === "ravens") team.spread = "16";
          if (team.team === "chargers") team.spread = "15";
          if (team.team === "pack") team.spread = "12";
          if (team.team === "rams") team.spread = "12.5";
          if (team.team === "chiefs") team.spread = "7";
          if (team.team === "cards") team.spread = "14.5";
          if (team.team === "bucs") {
            team.spread = "20";
            team.locked = true;
            team.rank = 8;
          }
          if (team.team === "pats") team.spread = "6";
          if (team.team === "saints") team.spread = "13";
          if (team.team === "vikings") team.spread = "13.5";
    ...
    describe("w/ dupe spreads", () => {
      describe("sorts 3 teams correctly", () => {
        beforeEach(() => {
          ...
          teams = teams.filter((team) => teams2Find.includes(team.team));
        });

        it("dupe spreads are locked", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "8";
            if (team.team === "colts") {
              team.spread = "7";
              team.locked = true;
              team.rank = 2;
        ...
        it("dupe spreads are not locked, locked spread is not in between, locked is ranked last", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "8";
            if (team.team === "titans") team.spread = "8";
            if (team.team === "colts") {
              team.spread = "7";
              team.locked = true;
              team.rank = 1;
      ...
      describe("sorts 5 teams correctly", () => {
        ...
        it("dupe spreads are locked", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "7.5";
            if (team.team === "colts") {
              team.spread = "8";
              team.locked = true;
              team.rank = 3;
            ...
            if (team.team === "pack") team.spread = "10";
            if (team.team === "ravens") team.spread = "6";
            return team;
          });
        ...
        it("dupe spreads are not locked, locked spread is not in between, locked is ranked last", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "colts") team.spread = "7.5";
            if (team.team === "titans") team.spread = "7.5";
            if (team.team === "pack") team.spread = "10";
            if (team.team === "ravens") team.spread = "10";
            return team;
          });
        ...
        it("dupe spreads are not locked, locked spread is not in between, locked is ranked first", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "colts") team.spread = "7";
            if (team.team === "titans") team.spread = "7.5";
            if (team.team === "pack") team.spread = "10";
            if (team.team === "ravens") team.spread = "10";
            return team;
        ...
        it("dupe spreads are not locked, locked spread is in between", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16";
            if (team.team === "colts") {
              team.spread = "1";
              team.locked = true;
              team.rank = 2;
            }
            if (team.team === "titans") team.spread = "13.5";
            if (team.team === "pack") team.spread = "10";
            if (team.team === "ravens") team.spread = "10";
            return team;
          });
        ...
        it("dupe spreads are not locked, locked spread is in between", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16";
            if (team.team === "colts") team.spread = "10";
            if (team.team === "titans") team.spread = "16";
            if (team.team === "pack") {
              team.spread = "5";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "ravens") team.spread = "13.5";
            return team;
          });
      ...
      describe("sorts 10 teams correctly", () => {
        ...
        it("2+ locked w/ 1 same spread, locks are in sequetial order, no dupes in non-locked - a non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16";
            if (team.team === "colts") team.spread = "14.5";
            if (team.team === "titans") {
              team.spread = "10";
              team.locked = true;
              team.rank = 3;
            }
            if (team.team === "wash") team.spread = "15";
            if (team.team === "eagles") team.spread = "9";
            if (team.team === "browns") team.spread = "8.5";
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "chargers") team.spread = "12";
            if (team.team === "pack") team.spread = "2";
            if (team.team === "rams") team.spread = "10";
            return team;
          });
        ...
        it("2+ locked w/ 1 same spread, locks are in sequetial order, no dupes in non-locked - no non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "chargers") team.spread = "12";
            if (team.team === "pack") team.spread = "2";
            if (team.team === "rams") team.spread = "3";
            return team;
          });
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are in sequetial order, no dupes in non-locked, a non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16"; //10
            if (team.team === "colts") team.spread = "14.5"; //6
            if (team.team === "titans") {
              team.spread = "5";
              team.locked = true;
              team.rank = 3;
            }
            if (team.team === "wash") team.spread = "15"; //9
            if (team.team === "eagles") {
              team.spread = "10";
              team.locked = true;
              team.rank = 8;
            }
            if (team.team === "browns") team.spread = "4.4"; //4
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 7;
            }
            if (team.team === "chargers") team.spread = "10"; //5
            if (team.team === "pack") {
              team.spread = "5";
              team.locked = true;
              team.rank = 2;
            }
            if (team.team === "rams") team.spread = "3"; //1
            return team;
          });
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are in sequetial order, no dupes in non-locked, no non locked team has the same spread as the lockedd upe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16"; //10
            if (team.team === "colts") team.spread = "13.5"; //6
            if (team.team === "titans") {
              team.spread = "5";
              team.locked = true;
              team.rank = 3;
            ...
            if (team.team === "chargers") team.spread = "14"; //5
            if (team.team === "pack") {
              team.spread = "5";
              team.locked = true;
              team.rank = 2;
        ...
        it("2+ locked w/ 1 same spread, locks are NOT in sequetial order, no dupes in non-locked, a non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "5"; //5
            if (team.team === "colts") team.spread = "14.5"; //8
            if (team.team === "titans") {
              team.spread = "5";
              team.locked = true;
              team.rank = 3;
            ...
            if (team.team === "wash") team.spread = "15"; //9
            if (team.team === "eagles") team.spread = "11"; //6
            if (team.team === "browns") team.spread = "4.5"; //4
            if (team.team === "ravens") team.spread = "4"; //2
            if (team.team === "chargers") team.spread = "12"; //7
            if (team.team === "pack") {
              team.spread = "5";
              team.locked = true;
              team.rank = 10;
        ...
        it("2+ locked w/ 1 same spread, locks are NOT in sequetial order, no dupes in non-locked, no non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "11.5"; //5
            if (team.team === "colts") team.spread = "14.5"; //8
            if (team.team === "titans") {
              team.spread = "5";
              team.locked = true;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are NOT in sequetial order, a dupe spread exists for non-locked teams, a non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "11"; //7 and 6
            if (team.team === "colts") team.spread = "14.5"; //9
            if (team.team === "titans") {
              team.spread = "5";
              team.locked = true;
              team.rank = 3;
            }
            if (team.team === "wash") team.spread = "11"; //7 and 6
            if (team.team === "eagles") {
              team.spread = "5";
              team.locked = true;
              team.rank = 10;
            ...
            if (team.team === "browns") team.spread = "8"; //5
            if (team.team === "ravens") team.spread = "4"; //4
            ...
            if (team.team === "rams") team.spread = "3"; //2
            return team;
          });
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are NOT in sequetial order, a dupes in non-locked, no non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "browns") team.spread = "3.5"; //5
            if (team.team === "ravens") team.spread = "4"; //4
            if (team.team === "chargers") {
              team.spread = "8";
              team.locked = true;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are NOT in sequetial order, no dupes in non-locked, a non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "11"; //8
            if (team.team === "colts") team.spread = "14.5"; //9
            if (team.team === "titans") {
              team.spread = "5";
              team.locked = true;
            ...
            if (team.team === "wash") team.spread = "5"; //6
            if (team.team === "eagles") {
              team.spread = "5";
              team.locked = true;
              team.rank = 10;
            }
            if (team.team === "browns") team.spread = "8"; //7
            if (team.team === "ravens") team.spread = "4"; //4
            if (team.team === "chargers") {
              team.spread = "8";
              team.locked = true;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are NOT in sequetial order, no dupes in non-locked, no non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "wash") team.spread = "5"; //7
            if (team.team === "eagles") {
              team.spread = "5";
              team.locked = true;
              team.rank = 10;
            }
            if (team.team === "browns") team.spread = "1"; //2
            if (team.team === "ravens") team.spread = "4"; //6
            if (team.team === "chargers") {
              team.spread = "8";
              team.locked = true;
              team.rank = 5;
        ...
        it("2+ non-locked w/ 1 same spread, no dupes in locked, a non locked team has the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "11"; //7-5-4
            if (team.team === "colts") team.spread = "14.5"; //10
            if (team.team === "titans") team.spread = "12"; //8
            if (team.team === "wash") team.spread = "11"; //7-5-4
            if (team.team === "eagles") {
              team.spread = "5";
              team.locked = true;
              team.rank = 6;
            }
            if (team.team === "browns") team.spread = "11"; //7-5-4
            if (team.team === "ravens") team.spread = "9"; //3
            if (team.team === "chargers") team.spread = "5"; //2
            if (team.team === "pack") team.spread = "13"; //9
            if (team.team === "rams") team.spread = "3"; //1
            return team;
          });
        ...
        it("2+ non-locked w/ 1 same spread, no dupes in locked, no non-locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "colts") team.spread = "14.5"; //10
            if (team.team === "titans") team.spread = "12"; //8
            if (team.team === "wash") team.spread = "2"; //1
            if (team.team === "eagles") {
              team.spread = "5";
              team.locked = true;
              team.rank = 6;
            ...
            if (team.team === "browns") team.spread = "11"; //7-5-4
            if (team.team === "ravens") team.spread = "11"; //7-5-4
            if (team.team === "chargers") team.spread = "9.5"; //3
            if (team.team === "pack") team.spread = "13"; //9
            if (team.team === "rams") team.spread = "3"; //2
            return team;
          });
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, no dupes in locked, a non locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "11"; //8-7-5
            if (team.team === "colts") team.spread = "14.5"; //10
            if (team.team === "titans") team.spread = "12"; //9
            if (team.team === "wash") team.spread = "11"; //8-7-5
            if (team.team === "eagles") {
              team.spread = "10";
              team.locked = true;
              team.rank = 6;
            }
            if (team.team === "browns") team.spread = "11"; //8-7-5
            if (team.team === "ravens") team.spread = "9"; //3-2
            if (team.team === "chargers") team.spread = "9"; //3-2
            if (team.team === "pack") team.spread = "2"; //1
            if (team.team === "rams") team.spread = "10"; //4
            return team;
          });
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, no dupes in locked, no non locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "browns") team.spread = "11"; //8-7-5
            if (team.team === "ravens") team.spread = "9"; //4-3
            if (team.team === "chargers") team.spread = "9"; //4-3
            if (team.team === "pack") team.spread = "2"; //2
            if (team.team === "rams") team.spread = "3"; //1
            return team;
          });
        ...
        it("2+ non-locked w/ 1 same spread, no dupes in locked, a non locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "11"; //7-6
            if (team.team === "colts") team.spread = "14.5"; //10
            if (team.team === "titans") team.spread = "12"; //9
            if (team.team === "wash") team.spread = "11.5"; //8
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 2;
            }
            if (team.team === "browns") team.spread = "8.5"; //4
            if (team.team === "ravens") team.spread = "9"; //5
            if (team.team === "chargers") team.spread = "11"; //7-6
            if (team.team === "pack") team.spread = "2"; //1
            if (team.team === "rams") team.spread = "3"; //3
            return team;
          });
        ...
        it("2+ non-locked w/ 1 same spread, no dupes in locked, no non locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "browns") team.spread = "8"; //4
            if (team.team === "ravens") team.spread = "9"; //5
            if (team.team === "chargers") team.spread = "11"; //7-6
            if (team.team === "pack") team.spread = "2"; //1
            if (team.team === "rams") team.spread = "3"; //3
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, no dupes in locked, a non locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16"; //10-9-8
            if (team.team === "colts") team.spread = "1.5"; //1
            if (team.team === "titans") team.spread = "16"; //10-9-8
            if (team.team === "wash") team.spread = "8.5"; //6-5
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 2;
            ...
            if (team.team === "browns") team.spread = "8"; //4
            if (team.team === "ravens") team.spread = "9"; //7
            if (team.team === "chargers") team.spread = "8.5"; //6-5
            if (team.team === "pack") team.spread = "2"; //3
            if (team.team === "rams") team.spread = "16"; //10-9-8
            return team;
          });
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, no non locked team has the same spread as the locked spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "16"; //10-9-7
            if (team.team === "colts") team.spread = "1.5"; //1
            if (team.team === "titans") team.spread = "16"; //10-9-7
            if (team.team === "wash") team.spread = "7"; //4-3
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 8;
            ...
            if (team.team === "browns") team.spread = "8"; //5
            if (team.team === "ravens") team.spread = "9"; //6
            if (team.team === "chargers") team.spread = "7"; //4-3
            if (team.team === "pack") team.spread = "2"; //2
            if (team.team === "rams") team.spread = "16"; //10-9-7
            return team;
          });
        ...
        it("2+ locked w/ 1 same spread, locks are in sequetial order, dupes for non-locked too, non locked teams have the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "4"; //2
            if (team.team === "colts") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 7;
            }
            if (team.team === "titans") team.spread = "16"; //10
            if (team.team === "wash") team.spread = "7"; //3
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 6;
            }
            if (team.team === "browns") team.spread = "8.5"; //9-5
            if (team.team === "ravens") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 8;
            }
            if (team.team === "chargers") team.spread = "7.5"; //4
            if (team.team === "pack") team.spread = "8.5"; //9-5
            if (team.team === "rams") team.spread = "1"; //1
            return team;
          });
        ...
        it("2+ locked w/ 1 same spread, locks are in sequetial order, dupes for non-locked too, non locked teams have diff dupe spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "4"; //5
            if (team.team === "colts") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 3;
            ...
            if (team.team === "titans") team.spread = "16"; //10
            if (team.team === "wash") team.spread = "7"; //6
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "browns") team.spread = "15"; //9-8
            if (team.team === "ravens") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 2;
            }
            if (team.team === "chargers") team.spread = "7.5"; //7
            if (team.team === "pack") team.spread = "15"; //9-8
            if (team.team === "rams") team.spread = "1"; //1
            return team;
          });
        ...
        it("2+ locked w/ 1 same spread, locks are NOT sequetial order, dupes for non-locked too, non locked teams have the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "4"; //3
            if (team.team === "colts") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 9;
            }
            if (team.team === "titans") team.spread = "8.5"; //8-7
            if (team.team === "wash") team.spread = "7"; //5
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "browns") team.spread = "8.5"; //8-7
            if (team.team === "ravens") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 1;
            }
            if (team.team === "chargers") team.spread = "7.5"; //6
            if (team.team === "pack") team.spread = "15"; //10
            if (team.team === "rams") team.spread = "1"; //2
            return team;
          });
        ...
        it("2+ locked w/ 1 same spread, locks are NOT sequetial order, dupes for non-locked too, non locked teams have diff spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "titans") team.spread = "6"; //6-5
            if (team.team === "wash") team.spread = "7"; //8
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "browns") team.spread = "6"; //6-5
            if (team.team === "ravens") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 1;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are in NOT sequetial order, dupes for non-locked too, non locked teams have the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "titans") team.spread = "8.5"; //7-5
            if (team.team === "wash") team.spread = "11"; //8
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "browns") team.spread = "8.5"; //7-5
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 6;
            }
            if (team.team === "chargers") team.spread = "7.5"; //3
            if (team.team === "pack") team.spread = "15"; //10
            if (team.team === "rams") {
              team.spread = "10";
              team.locked = true;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are in NOT sequetial order, dupes for non-locked too, non locked teams have diff spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "titans") team.spread = "16"; //10-8
            if (team.team === "wash") team.spread = "11"; //5
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 4;
            }
            if (team.team === "browns") team.spread = "16"; //10-8
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 6;
            ...
            if (team.team === "chargers") team.spread = "7.5"; //3
            if (team.team === "pack") team.spread = "15"; //7
            if (team.team === "rams") {
              team.spread = "10";
              team.locked = true;
              team.rank = 1;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are in sequetial order, dupes for non-locked too, non locked teams have the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "8.5"; //2-1
            if (team.team === "colts") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 9;
            ...
            if (team.team === "titans") team.spread = "16"; //10
            if (team.team === "wash") team.spread = "11"; //7
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 8;
            }
            if (team.team === "browns") team.spread = "8.5"; //2-1
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 5;
            }
            if (team.team === "chargers") team.spread = "10"; //6-3
            if (team.team === "pack") team.spread = "10"; //6-3
            if (team.team === "rams") {
              team.spread = "10";
              team.locked = true;
              team.rank = 4;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are in sequetial order, dupes for non-locked too, non locked teams have diff spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "14"; //10
            if (team.team === "colts") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 9;
            }
            if (team.team === "titans") team.spread = "11"; //7-6
            if (team.team === "wash") team.spread = "11"; //7-6
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 8;
            }
            if (team.team === "browns") team.spread = "8"; //3
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 5;
            }
            if (team.team === "chargers") team.spread = "1"; //2-1
            if (team.team === "pack") team.spread = "1"; //2-1
            if (team.team === "rams") {
              team.spread = "10";
              team.locked = true;
              team.rank = 4;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are NOT in sequetial order, dupes for non-locked too, non locked teams have the same spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "8.5"; //5-3
            if (team.team === "colts") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 2;
            }
            if (team.team === "titans") team.spread = "8.5"; //5-3
            if (team.team === "wash") team.spread = "11"; //10
            if (team.team === "eagles") {
              team.spread = "8.5";
              team.locked = true;
              team.rank = 8;
            }
            if (team.team === "browns") team.spread = "10"; //9-7
            if (team.team === "ravens") {
              team.spread = "10";
              team.locked = true;
              team.rank = 6;
            }
            if (team.team === "chargers") team.spread = "10"; //9-7
            if (team.team === "pack") team.spread = "1"; //1
            if (team.team === "rams") {
              team.spread = "10";
              team.locked = true;
              team.rank = 4;
        ...
        it("2+ locked w/ same spread for 2 diff spreads, locks are NOT in sequetial order, dupes for non-locked too, non locked teams have diff spread as the locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "bills") team.spread = "8.5";
            if (team.team === "colts") {
              team.spread = "8";
              team.locked = true;
              team.rank = 2;
            }
            if (team.team === "titans") team.spread = "8.5";
            if (team.team === "wash") team.spread = "11";
            if (team.team === "eagles") {
              team.spread = "8";
              team.locked = true;
              team.rank = 8;
            }
            if (team.team === "browns") team.spread = "10";
            if (team.team === "ravens") {
              team.spread = "4";
              team.locked = true;
              team.rank = 6;
            }
            if (team.team === "chargers") team.spread = "10";
            if (team.team === "pack") team.spread = "1";
            if (team.team === "rams") {
              team.spread = "4";
              team.locked = true;
              team.rank = 4;
      ...
      describe("sorts 16 teams correctly", () => {
        it("2+ non-locked w/ same spread, only 1 team = locked, locked team has the same spread as the non-locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "chiefs") team.spread = "16"; //16
            if (team.team === "eagles") {
              team.spread = "9";
              team.locked = true;
              team.rank = 3;
            }
            if (team.team === "ravens") team.spread = "9"; //12-11-10
            if (team.team === "browns") team.spread = "15"; //15
            if (team.team === "pack") team.spread = "1"; //1
            if (team.team === "titans") team.spread = "9"; //12-11-10
            if (team.team === "colts") team.spread = "6"; //6
            if (team.team === "vikings") team.spread = "7"; //7
            if (team.team === "wash") team.spread = "7.5"; //8
            if (team.team === "saints") team.spread = "9"; //12-11-10
            if (team.team === "bills") team.spread = "8"; //9
            if (team.team === "pats") team.spread = "12.5"; //13
            if (team.team === "bucs") team.spread = "14"; //14
            if (team.team === "cards") team.spread = "5"; //5
            if (team.team === "rams") team.spread = "3"; //2
            if (team.team === "chargers") team.spread = "4"; //4
            return team;
          });
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, only 1 team = locked, locked team has the same spread as the non-locked dupe spread", () => {
          teams = teams.map((team) => {
            if (team.team === "chiefs") team.spread = "7.5"; //8-7
            if (team.team === "eagles") {
              team.spread = "7.5";
              team.locked = true;
              team.rank = 11;
            }
            if (team.team === "ravens") team.spread = "9"; //13-12-10
            if (team.team === "browns") team.spread = "15"; //16
            if (team.team === "pack") team.spread = "1"; //1
            if (team.team === "titans") team.spread = "9"; //13-12-10
            if (team.team === "colts") team.spread = "6"; //5
            if (team.team === "vikings") team.spread = "7"; //6
            if (team.team === "wash") team.spread = "7.5"; //8-7
            if (team.team === "saints") team.spread = "9"; //13-12-10
            if (team.team === "bills") team.spread = "8"; //9
            if (team.team === "pats") team.spread = "12.5"; //14
            if (team.team === "bucs") team.spread = "14"; //15
            if (team.team === "cards") team.spread = "5"; //4
            if (team.team === "rams") team.spread = "3"; //2
            if (team.team === "chargers") team.spread = "4"; //3
            return team;
          });
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, only 1 team = locked, locked team has diff spread as the non-locked dupe spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "browns") team.spread = "15"; //16
            if (team.team === "pack") team.spread = "1"; //1
            if (team.team === "bucs") team.spread = "9"; //13-12-10
            if (team.team === "colts") team.spread = "6"; //5
            if (team.team === "vikings") team.spread = "7"; //6
            if (team.team === "wash") team.spread = "7.5"; //8-7
            if (team.team === "saints") team.spread = "9"; //13-12-10
            if (team.team === "bills") team.spread = "8"; //9
            if (team.team === "pats") team.spread = "12.5"; //14
            if (team.team === "titans") team.spread = "14"; //15
            if (team.team === "cards") team.spread = "5"; //4
            if (team.team === "rams") team.spread = "3"; //2
            if (team.team === "chargers") team.spread = "4"; //3
            return team;
        ...
        it("2+ non-locked w/ same spread, 2+ teams = locked, but with diff spreads for each lock, one of the locked spreads is the same as the dupe non-locked spread", () => {
          teams = teams.map((team) => {
            if (team.team === "chiefs") team.spread = "7.5"; //10-9
            if (team.team === "eagles") {
              team.spread = "2";
              team.locked = true;
              team.rank = 11;
            }
            if (team.team === "ravens") team.spread = "2"; //3-2-1
            if (team.team === "browns") team.spread = "15"; //16
            if (team.team === "pack") {
              team.spread = "18";
              team.locked = true;
            ...
            if (team.team === "titans") team.spread = "2"; //3-2-1
            if (team.team === "colts") team.spread = "6"; //7
            if (team.team === "vikings") team.spread = "7"; //8
            if (team.team === "wash") team.spread = "7.5"; //10-9
            if (team.team === "bills") team.spread = "2"; //3-2-1
            if (team.team === "saints") team.spread = "8"; //13
            if (team.team === "pats") {
              team.spread = "10.5";
              team.locked = true;
              team.rank = 12;
            ...
            if (team.team === "bucs") team.spread = "14"; //14
            if (team.team === "cards") team.spread = "5"; //6
            if (team.team === "rams") team.spread = "3"; //4
            if (team.team === "chargers") team.spread = "4"; //5
            return team;
          });
        ...
        it("2+ non-locked w/ same spread, 2+ teams = locked, but with diff spreads for each lock, locked spreads are diff from the dupe non-locked spread", () => {
          teams = teams.map((team) => {
            if (team.team === "browns") team.spread = "7.5"; //10-9
            if (team.team === "eagles") {
              team.spread = "16.5";
              team.locked = true;
              team.rank = 11;
            ...
            if (team.team === "ravens") team.spread = "2"; //3-2-1
            if (team.team === "chiefs") team.spread = "15"; //16
            if (team.team === "pack") {
              team.spread = "18";
              team.locked = true;
              team.rank = 15;
            ...
            if (team.team === "vikings") team.spread = "7"; //8
            if (team.team === "wash") team.spread = "7.5"; //10-9
            if (team.team === "saints") team.spread = "2"; //3-2-1
            if (team.team === "bills") team.spread = "8"; //13
            if (team.team === "pats") {
              team.spread = "10.5";
              team.locked = true;
              team.rank = 12;
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, 2+ teams = locked, but with diff spreads for each lock, one of the locked spreads is the same as the dupe non-locked spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "titans") team.spread = "2"; //3-2-1
            if (team.team === "colts") team.spread = "6"; //7
            if (team.team === "saints") team.spread = "7"; //8
            if (team.team === "wash") team.spread = "7.5"; //10-9
            if (team.team === "vikings") team.spread = "2"; //3-2-1
            if (team.team === "bills") team.spread = "8"; //13
            if (team.team === "pats") {
              team.spread = "10.5";
              team.locked = true;
        ...
        it("2+ non-locked w/ same spread for 2 diff spreads, 2+ teams = locked, but with diff spreads for each lock, locked spreads are diff from the dupe non-locked spread", () => {
          teams = teams.map((team) => {
            ...
            if (team.team === "eagles") team.spread = "2"; //3-2-1
            if (team.team === "browns") team.spread = "15"; //16
            if (team.team === "pack") {
              team.spread = "18";
              team.locked = true;
            ...
            if (team.team === "vikings") team.spread = "7"; //8
            if (team.team === "wash") team.spread = "7.5"; //10-9
            if (team.team === "rams") team.spread = "2"; //3-2-1
            if (team.team === "bills") team.spread = "8"; //13
            if (team.team === "pats") {
              team.spread = "10.5";
              team.locked = true;
            ...
            if (team.team === "bucs") team.spread = "14"; //14
            if (team.team === "cards") team.spread = "5"; //6
            if (team.team === "saints") team.spread = "3"; //4
            if (team.team === "chargers") team.spread = "4"; //5
            return team;
          });
